<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="allpersonhistory.aspx.cs" Inherits="ZDH_OA.Employee.list.allpersonhistory" %>
        ...
        <article class="htmleaf-container">
            <div class="tabs">
                <div style="background-color: #72ccf5;">
                    <ul>
                        <a style="margin: 0 5px; white-space: nowrap; font-size: 28px; position: relative; left: 550px; top: 5px">科室历史工作量查询</a>
                    </ul>
                    <div style="background-color: #72ccf5; position: relative;">
                        ...
                        <a style="margin: 0 5px 5px auto; white-space: nowrap; font-size: 22px; position: relative; left: 550px; top: -4px">
                            <dx:ASPxButton ID="submit" runat="server" Theme="Material" Width="40px" Text="确定" OnClick="submit_Click" />
                        </a>
                    </div>
                </div>
                ...
                <div class="tabs-content">
                    ...
                    <div tab-id="3" class="tab form tab3">
